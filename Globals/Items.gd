...
var items_list: Array[Evidence] = [
	Evidence.new("Trash Can", "This is a description of the item for the trash can", {Global.grandma: true, Global.little_child: false, Global.teenager: false, Global.junkie: false}, preload("res://Items/TrashCan.png"), true),
